...
const imgs = ['/new/tr1.png','/new/tr2.png'];
export default function FullView2() {
  ...
  return (
    ...
    >
      ...
      <img src={img} alt="full" style={{ height: '100vh', width: 'auto', objectFit: 'contain', display: 'block', margin: '0 auto', maxWidth: '100vw', maxHeight: '100vh' }} />
    </div>
  );
} 